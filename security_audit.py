    ...
    def generate_report(self):
        ...
        if total_checks > 0:
            ...
            if security_score >= 90:
                ...
                print("⚠️  Good security with minor issues - Address before production")
            elif security_score >= 60:
                print("⚠️  Moderate security concerns - Significant improvements needed")
            else:
                print("❌ Poor security posture - NOT ready for production")
