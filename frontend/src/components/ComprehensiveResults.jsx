...
import ABCTestVariants from './ABCTestVariants';
...
`;
  ...
  const renderOverviewTab = () => (
    <Box>
      ...
      {/* A/B/C Strategic Test Variants - Display below original/improved */}
      {results?.abTests?.abc_variants && results.abTests.abc_variants.length > 0 && (
        <Box sx={{ mt: 3, mb: 3 }}>
          <ABCTestVariants variants={results.abTests.abc_variants} />
        </Box>
      )}
  ...
  const renderABTestsTab = () => {
    // Show strategic A/B/C variants if available
    const abc_variants = results.abTests?.abc_variants || [];
    ...
    <Box>
      ...
      {/* Show Strategic A/B/C variants */}
      {hasStrategicVariants && (
        <ABCTestVariants variants={abc_variants} />
      )}
      
      {/* Traditional variations (for backward compatibility) */}
      {!hasStrategicVariants && results.abTests?.variations?.length > 0 && (
        <>
          <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 2, mt: 3 }}>
            Traditional Variations ({results.abTests?.variations?.length || 0} Ready)
          </Typography>
